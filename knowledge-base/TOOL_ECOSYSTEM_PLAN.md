...
| Notion | Pending | Search, read pages/databases |
...
|--------|----------|-----------|--------|
| PostgreSQL | P0 | query_db, insert_record, update_record, get_schema, search_knowledge, log_pipeline_run | Not started |
| Google Tasks | P1 | list_tasks, create_task, update_task, complete_task, sync_to_db | Not started |
| Drive (write) | P1 | upload_file, create_doc, create_folder | Not started |
...
|-------|------|--------|--------|
| Phase 1 | Gateway scaffold + PostgreSQL module | 3-5 days | Not started |
| Phase 2 | Google Tasks + Drive Write modules | 2-3 days | Not started |
| Phase 3 | Bharatvarsh Admin + Lore Search modules | 2-3 days | Not started |
| Phase 4 | Local STDIOs + WhatsApp + Content Tracker | 1-2 days | Not started |
...
*Update this document when modules are added to the gateway or new connectors are activated.*
