...
def register_tools(mcp: FastMCP, get_pool) -> None:
    ...
    async def _x_request_oauth1(
        ...
        # For GET with params, include in signature
        extra_params = {}
        if params:
    ...
    async def _log_post(pool, content: str, post_id: str | None, url: str | None,
                        status: str, error: str | None, metadata: dict | None) -> str:
